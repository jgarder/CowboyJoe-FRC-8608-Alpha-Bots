...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        angleEncoder = new CANCoder(moduleConstants.cancoderID,Constants.Canivore.CanivoreBus1Name);
        configAngleEncoder();

        /* Angle Motor Config */
        mAngleMotor = new TalonFX(moduleConstants.angleMotorID,Constants.Canivore.CanivoreBus1Name);
        configAngleMotor();

        /* Drive Motor Config */
        mDriveMotor = new TalonFX(moduleConstants.driveMotorID,Constants.Canivore.CanivoreBus1Name);
        configDriveMotor();
